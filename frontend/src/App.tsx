          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Climate probability analysis based on Earth observation data provided by NASA
              </p>
            </div>
          </div>
              ...
              <CardContent className="p-4">
                ...
                {!canGenerateData && (
                  <p className="text-sm text-muted-foreground mt-2 text-center">
                    Select a location and period to continue
                  </p>
                )}
                ...
                {canGenerateData && !weatherData && (
                  <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                    <p className="text-sm text-blue-800">
                      Ready to analyze climate data for <strong>{selectedLocation?.name}</strong>
                      {selectedDateRange && (
                        <> the period <strong>{formatDateRange(selectedDateRange)}</strong></>
                      )}
                    </p>
                  </div>
                )}
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <div className="text-center">
                      <h3 className="font-medium">Processing NASA data</h3>
              ...
              <Card>
                <CardContent className="p-8">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h3 className="font-medium mb-2">Welcome to the Climate Dashboard</h3>
                      <p className="text-muted-foreground">
                        Select a location and time period to begin analyzing NASA climate data.
                      </p>
                    </div>
