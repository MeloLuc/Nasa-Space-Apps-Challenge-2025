...
export const convertAPITemperatureData = (apiData: APITemperatureResponse) => {
  ...
  return {
    ...
    description: `${apiData.analysis.most_likely_condition} is the most likely condition`,
    rawData: apiData,
...
export const convertAPIPrecipitationData = (apiData: APIPrecipitationResponse) => {
  ...
  return {
    ...
    description: `${translatePrecipitationCondition(apiData.analysis.most_likely_condition)} is the most likely condition`,
    rawData: apiData,
    mostLikelyCondition: apiData.analysis.most_likely_condition,
    allConditions: analysis
  };
...
export const convertAPIHumidityData = (apiData: APIHumidityResponse) => {
  ...
  const translateHumidityCondition = (condition: string): string => {
    const translations: { [key: string]: string } = {
      ...
      'Very High Humidity': 'very High Humidity'
    };
    return translations[condition] || condition;
  };
  ...
  return {
    ...
    description: `${translateHumidityCondition(apiData.analysis.most_likely_condition)} is the most likely condition`,
    rawData: apiData,
    mostLikelyCondition: apiData.analysis.most_likely_condition,
    allConditions: analysis
  };
